...
Jupyter Notebooks make coding in Python much easier and allow for nice integrated visualizations. Jupyter is already set up for you in the `geoscripting` environment. 

If geoscripting environment is not there yet (check with 'conda info --envs'), create one for todays tutorial with Jupyter Notebook:
...
roads = gpd.GeoDataFrame(gpd.read_file('Roads.gml'))
