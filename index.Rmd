...
We will make a graph with the _seaborn_ module and plot it with _matplotlib_. Give it a try! A 
...
Let's make an advanced map in Python with some markers and a way to measure the distance between markers. Some icons of the free font library [FontAwesome](https://fontawesome.com/icons) are used.
...
x, y = 174094, 444133
xmin, xmax, ymin, ymax = x-750, x+750, y-750, y+750
...
wageningenMap = folium.Map(location=[avg_lat, avg_lon], tiles = "Stamen Toner", zoom_start = 14)

folium.Marker([51.987530, 5.666049], popup='Gaia at Wageningen University Campus',
              icon=folium.Icon(color='green',icon='university',prefix='fa')
             ).add_to(wageningenMap)
folium.Marker([51.978761, 5.663023], popup='Shopping center Tarthorst',
              icon=folium.Icon(color='red', icon='fa-shopping-cart', prefix='fa') 
             ).add_to(wageningenMap)


wageningenMap.add_child(PolyLine(locations=[[51.987530, 5.666049], [51.986810, 5.666649], [51.985501, 5.661650], 
                                            [51.981741, 5.664579], [51.979521, 5.664321], [51.979455, 5.663795],
                                            [51.979078, 5.663753], [51.978761, 5.663023]], 
                                popup="Path from Gaia to Shopping Center")

wageningenMap.add_child(ImageOverlay(imageFilename, [[min_lat, min_lon], [max_lat, max_lon]], opacity=0.6))

wageningenMap.add_child(MeasureControl())
folium.LayerControl().add_to(wageningenMap)
wageningenMap
```
