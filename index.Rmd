...
<img src="Sepal_Width_Image.png" alt="Upside-down sloths are so cute", width = "60%">
...
wageningenMap.save('wageningenMap.html') # Some other IDEs allow interactive visualization, but the created Folium can also be accessed via the file
```

<img src="WUR_Folium_Map.png" alt="Upside-down sloths are so cute", width = "100%">
